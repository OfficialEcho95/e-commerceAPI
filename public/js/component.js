      ...
      <div class="container-menu-desktop">
        ...
        <div class="top-bar">
          <div class="content-topbar flex-sb-m h-full container">
            ...
            <!-- User Not logged in -->
            <div class="not-logged-in right-top-bar flex-w h-full">
              <a href="#" class="flex-c-m trans-04 p-lr-25"> Register </a>

              <a href="#" class="flex-c-m trans-04 p-lr-25"> Login </a>
            </div>
            <!-- User logged in -->
            <div class="logged-in right-top-bar flex-w h-full d-none">
        ...
        <ul class="topbar-mobile">
          ...
          <li>
            <div class="right-top-bar flex-w h-full">
              <a href="#" class="flex-c-m p-lr-10 trans-04"> Register </a>

              <a href="#" class="flex-c-m p-lr-10 trans-04"> Login </a>
            </div>
          </li>
        </ul>
